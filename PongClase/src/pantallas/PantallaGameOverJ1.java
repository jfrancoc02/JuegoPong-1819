 ...
 *         una imagen de game over cuando gana el jugador1.
 *
 */
public class PantallaGameOverJ1 implements Pantalla {
	...
	public PantallaGameOverJ1(PanelJuego panelJuego, double tiempoJuego) {
	...
	public void inicializarPantalla() {
		try {
			imagenOriginalGameOver = ImageIO.read(new File("Imagenes/winj1.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
