...
/**
 * 
 * @author JonathanFrancoClemente. Clase PantallaGameOver3. Esta clase muestra
 *         una imagen de game over cuando gana CPU.
 *
 */
public class PantallaGameOver3 implements Pantalla {
	...
	public PantallaGameOver3(PanelJuego panelJuego, double tiempoJuego) {
	...
	public void inicializarPantalla() {
		try {
			imagenOriginalGameOver = ImageIO.read(new File("Imagenes/winCpu.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
